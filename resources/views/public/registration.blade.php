...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('public.registration.store') }}" method="POST" enctype="multipart/form-data" id="registration-form">
            @csrf
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="3" class="block mt-1 w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('address') }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="pin_code" class="block mt-1 w-full" type="text" name="pin_code" :value="old('pin_code')" maxlength="6" required />
...
<script>
    ...
    // Filter courses by category (simplified - no institute filtering needed since courses are already filtered)
    function filterCoursesByCategory(categoryId) {
        ...
        // Then, if a category is selected, filter by category
        if (categoryId) {
