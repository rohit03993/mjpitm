...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('courses') }}" class="inline-flex items-center text-green-600 hover:text-green-800 font-semibold">
    ...
    <div class="text-center mb-12">
        ...
        @endif
        <h1 class="text-4xl font-bold text-green-900 mb-4">{{ $category->name }}</h1>
