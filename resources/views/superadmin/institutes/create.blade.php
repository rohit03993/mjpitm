<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('superadmin.institutes.store') }}">
                @csrf
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required placeholder="e.g., Mahatma Jyotiba Phule Institute of Technology & Management" />
                        ...
                        <div>
                            ...
                            <x-text-input id="domain" class="block mt-1 w-full" type="text" name="domain" :value="old('domain')" required placeholder="e.g., mjpitm.in" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="3" class="block mt-1 w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500" placeholder="Brief description of the institute...">{{ old('description') }}</textarea>
