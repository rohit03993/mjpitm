...
<head>
    ...
    <title>Guest Login - {{ config('app.name', 'Laravel') }}</title>
        ...
        <div class="max-w-md w-full space-y-6 sm:space-y-8">
            <div>
                <div class="flex justify-center mb-4">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 bg-blue-500 rounded-full flex items-center justify-center shadow-lg">
            ...
            <form method="POST" action="{{ route('staff.login') }}" class="mt-6 sm:mt-8 space-y-4 sm:space-y-6 bg-white rounded-lg shadow-lg p-4 sm:p-6 sm:p-8">
                @csrf
                ...
                <div>
                    ...
                    <input id="email" 
                           class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base sm:text-sm py-3 px-3" 
                           type="email" 
                           name="email" 
                           value="{{ old('email') }}" 
                           required 
