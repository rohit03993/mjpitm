                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $subject->name)" required placeholder="e.g., Data Structures and Algorithms" />
                        ...
                        <div>
                            ...
                            <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', $subject->code)" required placeholder="e.g., DSA301" />
                        ...
                        <div>
                            ...
                            <x-text-input id="semester" class="block mt-1 w-full" type="number" name="semester" :value="old('semester', $subject->semester)" required min="1" max="20" />
                        ...
                        <div>
                            ...
                            <x-text-input id="credits" class="block mt-1 w-full" type="number" name="credits" :value="old('credits', $subject->credits)" min="0" max="10" placeholder="e.g., 4" />
