                ...
                <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="roll_number_code" class="block mt-1 w-full" type="text" name="roll_number_code" :value="old('roll_number_code', $category->roll_number_code)" placeholder="e.g., 01" maxlength="3" pattern="[0-9]{2,3}" />
                            <p class="mt-1 text-xs text-gray-500">2-3 digit code for roll number generation (used in format: {INSTITUTE_CODE}{YEAR}{CATEGORY_CODE}{RANDOM})</p>
                        ...
                        <div class="md:col-span-2">
                            ...
                            @if($category->image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('storage/' . $category->image) }}" alt="Current Category Image" class="w-48 h-48 object-cover rounded-lg border border-gray-300">
                                </div>
                            @endif
                            ...
                            <p class="mt-1 text-xs text-gray-500">Upload an image related to this category (Max 2MB, JPG/PNG/GIF). Leave empty to keep current image.</p>
