                                    ...
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex-1">
                                            ...
                                            @if($category->roll_number_code)
                                                <p class="text-xs font-medium text-purple-600 mb-1">Enrollment Number Code: <span class="font-bold">{{ $category->roll_number_code }}</span></p>
                                            @else
                                                <p class="text-xs font-medium text-red-600 mb-1">⚠ Enrollment Number Code: <span class="font-bold">Not Set</span></p>
                                            @endif
