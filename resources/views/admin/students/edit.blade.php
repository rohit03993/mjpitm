<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.students.update', $student->id) }}" method="POST" enctype="multipart/form-data" id="edit-form">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="mother_name" class="block mt-1 w-full" type="text" name="mother_name" :value="old('mother_name', $student->mother_name)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="father_name" class="block mt-1 w-full" type="text" name="father_name" :value="old('father_name', $student->father_name)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="aadhaar_number" class="block mt-1 w-full" type="text" name="aadhaar_number" :value="old('aadhaar_number', $student->aadhaar_number)" maxlength="12" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            @if($student->photo)
                                <div class="mb-2">
                                    ...
                                    <img src="{{ Storage::url($student->photo) }}" alt="Current Photo" class="w-32 h-32 object-cover rounded-lg border border-gray-300">
                                </div>
                            @endif
                            ...
                            <p class="mt-1 text-xs text-gray-500">Upload new passport size photograph (Max 2MB). Leave blank to keep current photo.</p>
                        ...
                        <div>
                            ...
                            @if($student->aadhar_front)
                                <div class="mb-2">
                                    <p class="text-sm text-gray-600 mb-2">Current Aadhar Front:</p>
                                    <img src="{{ Storage::url($student->aadhar_front) }}" alt="Current Aadhar Front" class="w-full h-48 object-contain rounded-lg border border-gray-300 bg-white">
                                </div>
                            @endif
                            <input id="aadhar_front" class="block mt-1 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" type="file" name="aadhar_front" accept="image/*" onchange="previewAadharFront(this)" />
                            ...
                            <p class="mt-1 text-xs text-gray-500">Upload new Aadhar card front side (Max 2MB). Leave blank to keep current.</p>
                        ...
                        <div>
                            ...
                            @if($student->aadhar_back)
                                <div class="mb-2">
                                    <p class="text-sm text-gray-600 mb-2">Current Aadhar Back:</p>
                                    <img src="{{ Storage::url($student->aadhar_back) }}" alt="Current Aadhar Back" class="w-full h-48 object-contain rounded-lg border border-gray-300 bg-white">
                                </div>
                            @endif
                            <input id="aadhar_back" class="block mt-1 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" type="file" name="aadhar_back" accept="image/*" onchange="previewAadharBack(this)" />
                            ...
                            <p class="mt-1 text-xs text-gray-500">Upload new Aadhar card back side (Max 2MB). Leave blank to keep current.</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone', $student->phone)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $student->email)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="country" class="block mt-1 w-full" type="text" name="country" :value="old('country', $student->country ?? 'India')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="nationality" class="block mt-1 w-full" type="text" name="nationality" :value="old('nationality', $student->nationality ?? 'Indian')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="district" class="block mt-1 w-full" type="text" name="district" :value="old('district', $student->district)" placeholder="Enter district name" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="address" name="address" rows="3" class="block mt-1 w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500">{{ old('address', $student->address) }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="pin_code" class="block mt-1 w-full" type="text" name="pin_code" :value="old('pin_code', $student->pin_code)" maxlength="6" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @php
                                    ...
                                    // Get existing qualifications indexed by examination type
                                    $existingQualifications = [];
                                    foreach($student->qualifications as $qual) {
                                        $existingQualifications[$qual->examination] = $qual;
                                    }
                                @endphp
                                @foreach($examinations as $key => $label)
                                    @php
                                        $existingQual = $existingQualifications[$key] ?? null;
                                    @endphp
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <input type="text" name="qualifications[{{ $loop->index }}][year_of_passing]" value="{{ old('qualifications.'.$loop->index.'.year_of_passing', $existingQual->year_of_passing ?? 'yyyy') }}" class="block w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500" placeholder="yyyy">
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <input type="text" name="qualifications[{{ $loop->index }}][board_university]" value="{{ old('qualifications.'.$loop->index.'.board_university', $existingQual->board_university ?? '') }}" class="block w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500">
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <input type="number" step="0.01" name="qualifications[{{ $loop->index }}][percentage]" value="{{ old('qualifications.'.$loop->index.'.percentage', $existingQual->percentage ?? '') }}" class="block w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500" placeholder="%" min="0" max="100">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 px-6 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @if($student->certificate_class_10th)
                                    <div class="mb-2">
                                        <p class="text-sm text-gray-600 mb-2">Current Certificate:</p>
                                        <a href="{{ Storage::url($student->certificate_class_10th) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800">View Current Certificate</a>
                                    </div>
                                @endif
                                ...
                                <p class="mt-1 text-xs text-gray-500">Upload Class 10th mark sheet/certificate (Image or PDF, Max 5MB). Leave blank to keep current.</p>
                            ...
                            <div>
                                ...
                                @if($student->certificate_class_12th)
                                    <div class="mb-2">
                                        <p class="text-sm text-gray-600 mb-2">Current Certificate:</p>
                                        <a href="{{ Storage::url($student->certificate_class_12th) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800">View Current Certificate</a>
                                    </div>
                                @endif
                                ...
                                <p class="mt-1 text-xs text-gray-500">Upload Class 12th mark sheet/certificate (Image or PDF, Max 5MB). Leave blank to keep current.</p>
                            ...
                            <div>
                                ...
                                @if($student->certificate_graduation)
                                    <div class="mb-2">
                                        <p class="text-sm text-gray-600 mb-2">Current Certificate:</p>
                                        <a href="{{ Storage::url($student->certificate_graduation) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800">View Current Certificate</a>
                                    </div>
                                @endif
                                ...
                                <p class="mt-1 text-xs text-gray-500">Upload Graduation degree/certificate (Image or PDF, Max 5MB). Leave blank to keep current.</p>
                            ...
                            <div>
                                ...
                                @if($student->certificate_others)
                                    <div class="mb-2">
                                        <p class="text-sm text-gray-600 mb-2">Current Certificate:</p>
                                        <a href="{{ Storage::url($student->certificate_others) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800">View Current Certificate</a>
                                    </div>
                                @endif
                                ...
                                <p class="mt-1 text-xs text-gray-500">Upload any other certificates (Image or PDF, Max 5MB). Leave blank to keep current.</p>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="institute_id" name="institute_id" class="block mt-1 w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500" required onchange="loadCategories(this.value)">
                                ...
                                @foreach($institutes as $institute)
                                    <option value="{{ $institute->id }}" {{ old('institute_id', $student->institute_id) == $institute->id ? 'selected' : '' }}>{{ $institute->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="course_id" name="course_id" class="block mt-1 w-full rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500" required onchange="loadCourseFees(this.value); updateSession();">
                                ...
                                @foreach($courses as $course)
                                    <option value="{{ $course->id }}" data-institute-id="{{ $course->institute_id }}" data-category-id="{{ $course->category_id }}" {{ old('course_id', $student->course_id) == $course->id ? 'selected' : '' }}>{{ $course->name }}@if($course->category) [{{ $course->category->name }}]@endif</option>
                                @endforeach
                            </select>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Only fill if you want to change the password. Minimum 8 characters.</p>
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 bg-blue-50 border-b border-blue-200">
                        <h3 class="text-lg font-semibold text-blue-900">Signature</h3>
                    </div>
                    <div class="p-6">
                        @if($student->signature)
                            <div class="mb-4">
                                <p class="text-sm text-gray-600 mb-2">Current Signature:</p>
                                <img src="{{ Storage::url($student->signature) }}" alt="Current Signature" class="w-48 h-24 object-contain rounded-lg border border-gray-300 bg-white">
                            </div>
                        @endif
                        <x-input-label for="signature" :value="__('Signature (Consent)')" />
                        <p class="text-sm text-gray-600 mb-3">Upload new signature if needed. Leave blank to keep current signature.</p>
                        <input id="signature" class="block mt-1 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" type="file" name="signature" accept="image/*" onchange="previewSignature(this)" />
                        ...
                        <p class="mt-1 text-xs text-gray-500">Upload scanned signature (Max 2MB). Leave blank to keep current.</p>
    ...
    <script>
        ...
        function initStatesAndDistricts() {
            ...
            const oldState = @json(old('state', $student->state));
