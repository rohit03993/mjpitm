        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                @if($student->status === 'active' && $student->roll_number)
                    ...
                    <a href="{{ route('admin.students.generate-semester-result', $student->id) }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
