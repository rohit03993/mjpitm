        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Website Registrations') }}
                </h2>
                <p class="text-sm text-gray-600 mt-1">Students who registered themselves from the website</p>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <!-- Search and Filters -->
                    <form method="GET" action="{{ route('admin.students.website-registrations') }}" class="mb-6 flex flex-col md:flex-row gap-4 items-end">
                        <div class="flex-1">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            @if(auth()->user() && auth()->user()->isSuperAdmin())
                                                ...
                                                <a href="{{ route('admin.students.edit', $student->id) }}" class="text-blue-600 hover:text-blue-900">Process</a>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
