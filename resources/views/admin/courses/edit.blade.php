                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="duration_years" class="block mt-1 w-full" type="number" name="duration_years" :value="old('duration_years', $course->duration_years)" required min="1" max="10" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="registration_fee" class="block mt-1 w-full" type="number" step="0.01" name="registration_fee" :value="old('registration_fee', $course->registration_fee)" min="0" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <x-text-input id="entrance_fee" class="block mt-1 w-full" type="number" step="0.01" name="entrance_fee" :value="old('entrance_fee', $course->entrance_fee)" min="0" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <x-text-input id="enrollment_fee" class="block mt-1 w-full" type="number" step="0.01" name="enrollment_fee" :value="old('enrollment_fee', $course->enrollment_fee)" min="0" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <x-text-input id="tuition_fee" class="block mt-1 w-full" type="number" step="0.01" name="tuition_fee" :value="old('tuition_fee', $course->tuition_fee)" min="0" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <x-text-input id="caution_money" class="block mt-1 w-full" type="number" step="0.01" name="caution_money" :value="old('caution_money', $course->caution_money)" min="0" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <x-text-input id="hostel_fee_amount" class="block mt-1 w-full" type="number" step="0.01" name="hostel_fee_amount" :value="old('hostel_fee_amount', $course->hostel_fee_amount)" min="0" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <x-text-input id="late_fee" class="block mt-1 w-full" type="number" step="0.01" name="late_fee" :value="old('late_fee', $course->late_fee)" min="0" placeholder="0.00" />
